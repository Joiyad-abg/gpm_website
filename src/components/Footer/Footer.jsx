    ...
    <Fragment>
      <footer className="bg-slate-900 bg-opacity-70 text-center">
          ...
          <div className="grid lg:grid-cols-3 gap-4 text-white">
            <div className="block p-6 rounded-lg max-w-md">
              ...
              <div className="flex gap-2 md:gap-4 justify-start items-center pt-4">
                ...
                <h2>graduatepackersmovers08@gmail.com</h2>
              </div>
              ...
              <p className="text-left">
                2024 Graduate Packers & Movers, All rights reserved
              </p>
            </div>
            ...
            <div className="p-6 md:mb-0">
              ...
              <iframe title="myFrame" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d954.6782249941856!2d77.62840462845807!3d12.867971399211614!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae6b37923efb1d%3A0x48b15b4c69f14a67!2s16%2C%20Lakshmi%20Layout%2C%20Begur%2C%20Bengaluru%2C%20Karnataka%20560114!5e1!3m2!1sen!2sin!4v1722308393788!5m2!1sen!2sin" width="200" height="200" style={{border:0}} loading="lazy"></iframe>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center text-xl text-gray-100 p-8 bg-black">
          Made with ❤️ by Graduate Packers & Movers
        </div>
      </footer>
    </Fragment>
  );
