  ...
  return (
    <div className="flex flex-col md:flex-row justify-evenly gap-4 mt-32">
      ...
      <div className="flex gap-4 items-center">
          ...
          <h2 className="text-red-500 font-semibold">graduatepackersmovers08@gmail.com</h2>
          </div>
        </div>
      </div>
      <div className="flex flex-row justify-start md:justify-center items-center gap-4 p-4">
        ...
        <div className="font-bold">
          ...
          <a href="tel:+91 8302335504" className="text-red-500">+91 8302335504</a>
      ...
      <div>
        <div className="flex gap-4 items-center p-4">
          ...
          <div>
            ...
            <p className="text-red-400 font-semibold">No. 18/15, Ground Floor, 7th Main,</p>
            <p className="text-red-400 font-semibold">Lakshmi Layout, Begur Village, Bangalore - 560068</p>
            </div>
          </div>
        </div>
      </div>
