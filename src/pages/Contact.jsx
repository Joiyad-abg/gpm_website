...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_rcalhfm", "template_kq5gn8x", e.target, "Bq21D8C5PywjV1XKK")
      .then(
        (result) => {
  ...
  return (
    <div className="pt-24 px-4 md:px-12">
      ...
      <form onSubmit={sendEmail}>
        ...
        <button
          type="submit"
          className=" w-full px-6 py-2.5 font-bold border-2 border-red-500  bg-white text-red-500 hover:text-white text-md leading-tight rounded hover:bg-red-500 hover:shadow-lg  focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
        >
          Send
        </button>
      </form>
      <Heading title="Reach to us" />
